...
This is my addition game project with markdown
## Java code
``` Java
...
Hello everyone.
Each of the following addition problems will be worth points.
The problems will get harder for each correct answer.
Get all of them correct for the best score.
What is 5 + 5?
10
Answer correct.
Your score is now: 10
So you think you’re smart huh? Increase difficulty. LEVEL = 100
What is 42 + 86?
3
Haha you answered incorrectly
...
Final Score: 20
Thanks for playing!
## This is my addition game using markdown
